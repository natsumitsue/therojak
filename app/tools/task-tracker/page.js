...
const inputCss = {
  ...
  color: '#e0e0ff', fontSize: '0.9rem', outline: 'none',
  fontFamily: 'sans-serif', transition: 'border-color 0.2s',
}

const labelCss = {
  display: 'block', color: '#4a4a7a', fontSize: '0.72rem',
...
function TaskCard({ task, onEdit, onDelete, onStatusChange }) {
  ...
  return (
    <div style={{
      ...
      opacity: isDone ? 0.65 : 1, transition: 'border-color 0.2s, opacity 0.2s',
    }}
    ...
    >
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem' }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {task.description && (
            <p style={{
              color: '#4a4a7a', fontSize: '0.78rem', margin: '0.3rem 0 0', lineHeight: 1.5,
    ...
    <div style={{ minHeight: '100vh', background: '#0a0a0f', fontFamily: 'sans-serif' }}>
      ...
      <header style={{
        ...
        <div style={{ maxWidth: '860px', margin: '0 auto', padding: '0 1.25rem', height: '52px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            {user && <span style={{ color: '#4a4a7a', fontSize: '0.75rem' }}>{user.email}</span>}
      ...
      <main style={{ position: 'relative', zIndex: 1, maxWidth: '860px', margin: '0 auto', padding: '1.5rem 1.25rem' }}>
          ...
          {[
            ...
            <div key={s.key}
              ...
              style={{
                ...
                borderRadius: '10px', padding: '0.85rem', cursor: 'pointer', transition: 'all 0.2s',
              }}
        ...
        {tasksLoading ? (
          ...
          <div style={{ textAlign: 'center', padding: '3.5rem 2rem', background: '#0d0d1a', border: '1px solid #1a1a3e', borderRadius: '12px' }}>
            <div style={{ fontSize: '2rem', marginBottom: '0.6rem' }}>{tasks.length === 0 ? '📋' : '🔍'}</div>
            <p style={{ color: '#4a4a7a', fontSize: '0.85rem', margin: 0 }}>
              {tasks.length === 0 ? 'No tasks yet. Hit "New task" to get started!' : 'No tasks match your filters.'}
            </p>
          </div>
        ) : (
